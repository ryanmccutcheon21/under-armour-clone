                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <Menu as="div" className="relative ml-12">
                                <div>
                                    <Menu.Button className="rounded-full p-1 mx-2 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-center">
                                {/* Under Armour Logo */}
                                <div className="flex flex-shrink-0 lg:absolute lg:left-0">
