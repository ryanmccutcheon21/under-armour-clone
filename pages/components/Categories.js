    ...
    return (
        <div className='flex flex-col items-center mt-10'>
            ...
            <div className='w-screen mt-10 px-5 md:flex'>
                <a className='cursor-pointer w-full mx-4' href='men'>
                    <Image
                ...
                <a className='cursor-pointer w-full mx-4' href='women'>
                    <Image
                ...
                <a className='cursor-pointer w-full mx-4' href='kids'>
                    <Image
                ...
                <a className='cursor-pointer w-full mx-4' href='shoes'>
                    <Image
