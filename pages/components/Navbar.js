...
const navigation = [
    { name: 'New', href: 'new/new', current: true },
    { name: 'Men', href: 'men/men', current: false },
    { name: 'Women', href: 'women/women', current: false },
    { name: 'Kids', href: 'kids/kids', current: false },
    { name: 'Shoes', href: 'shoes/shoes', current: false },
    { name: 'Curry', href: 'curry/curry', current: false },
    { name: 'Outlet', href: 'outlet/outlet', current: false },
]
                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-center">
                                {/* Under Armour Logo */}
                                <div className="flex flex-shrink-0 lg:absolute lg:left-0 justify-center mr-20 sm:mr-0">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                ...
                                {/* Search Button */}
                                <div className='flex lg:border-b-2 lg:border-b-gray-600 mr-2'>
                                    <input type='search' placeholder='Search UA' className='hidden lg:inline bg-black text-white border border-none focus:outline-none' />
                                    <button
                                        type="button"
